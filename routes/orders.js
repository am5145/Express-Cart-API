    ...
    try {
      ...
      for (const orderItem of orderItems) {
        ...
        if (orderItem.product.price > 1000 && orderItem.product.price <= 5000) {
          tax = orderItem.product.price * 0.12;
        } else if (orderItem.product.price > 5000) {
          tax = orderItem.product.price * 0.18;
        } else {
          tax = 200;
        }
  
        const totalPriceWithTax = orderItem.product.price + tax;
        totalPrice += totalPriceWithTax * orderItem.quantity;
      }
